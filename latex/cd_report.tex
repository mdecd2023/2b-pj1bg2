...
%=---------------報告製作核可證明---------------------=%
 ...
 {\begin{center}
    ...
    {\begin{minipage}[t]{10em}\underline{四設二乙\enspace 41023251 鄭立揚}\\ \underline{四設二乙\enspace 4102354\enspace 謝鴻元}\\ \underline{四設二乙\enspace 41023193\enspace 第三位}\\ \underline{四設二乙\enspace 41023194\enspace 第四位}\\ \underline{四設二乙\enspace 41023195\enspace 第五位}\\ %下劃線符號指令
    \end{minipage}}
         \par} %結束指定行距
